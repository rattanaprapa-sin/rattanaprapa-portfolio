    ...
    <section className="section-padding bg-light" id="contact">
      <div className="container">
        <div className="text-center mb-5">
          ...
          <p className="text-secondary lead">Let's connect and build something amazing together.</p>
        </div>
              ...
              >
                ...
                <div className="card border-0 shadow-sm rounded-4 hover-lift h-100 text-center p-2 p-lg-3">
                  <div className="card-body d-flex flex-column justify-content-center">
                    <h5 className="card-title fw-bold text-dark mb-2">{contact.title}</h5>
                    <p className="card-text text-secondary mb-0 text-break">
                      {contact.value}
                    </p>
                  </div>
                </div>
